        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            {[
              ...
              { label: t.sleep ?? 'Sleep', val: log.sleep, icon: '💤', color: '#A855F7' },
...
function HooperCard({ data, t }) {
  ...
  const STATUS_COLORS = { fresh:'#22C55E', normal:'#4A7AB5', strained:'#F59E0B', overreaching:'#EF4444' };
  const color = STATUS_COLORS[s.status] ?? A;
  return (
    ...
    <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border shadow-sm p-4" style={{ background: SU, borderColor: BO }}>
          ...
          <HooperCard data={latestHooper} t={t} />
        </div>
        ...
        <div className="rounded-2xl border shadow-sm p-4" style={{ background: SU, borderColor: BO }}>
          ...
          <RestqCard data={latestRestq} t={t} />
        </div>
      </div>
