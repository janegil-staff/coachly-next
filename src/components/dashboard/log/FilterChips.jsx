...
// Active chip's color matches the category (red for soreness, green for
// training, etc.). Filters adapted from recover with semantics for fitness.
...
export default function FilterChips({ activeFilter, setFilter, counts, t }) {
  const chips = [
    ...
    {
      key: "trainingDays",
      label: t.filterTrainingDays ?? "Training days",
      count: counts.trainingDays,
      color: "#16A34A",
    },
    {
      key: "restDays",
      label: t.filterRestDays ?? "Rest days",
      count: counts.restDays,
      color: "#F97316",
    },
    {
      key: "highSoreness",
      label: t.filterHighSoreness ?? "Soreness ≥4",
      count: counts.highSoreness,
      color: "#FB923C",
    },
    {
      key: "highEffort",
      label: t.filterHighEffort ?? "Effort ≥4",
      count: counts.highEffort,
      color: "#7C3AED",
    },
    {
      key: "notes",
