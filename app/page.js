        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex justify-center lg:justify-start items-end gap-3 sm:gap-5">
            <div className="hidden sm:block w-[130px] sm:w-[150px] lg:w-[170px] drop-shadow-2xl">
              <Image src="/screenshots/login.png" alt="Coachly login" width={440} height={950}
                className="w-full h-auto rounded-[1.8rem] border-[5px] border-slate-900 bg-slate-900" priority />
            </div>
            <div className="w-[160px] sm:w-[180px] lg:w-[200px] -mb-4 drop-shadow-2xl">
              <Image src="/screenshots/home.png" alt="Coachly home" width={440} height={950}
                className="w-full h-auto rounded-[1.8rem] border-[5px] border-slate-900 bg-slate-900" priority />
            </div>
            <div className="hidden sm:block w-[130px] sm:w-[150px] lg:w-[170px] drop-shadow-2xl">
              <Image src="/screenshots/diary.png" alt="Coachly diary" width={440} height={950}
        ...
        <div className="flex flex-col gap-3 w-full max-w-md mx-auto lg:mx-0">
          ...
          <form onSubmit={submit} className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div className="relative w-full aspect-[3/2] bg-slate-50 overflow-hidden">
              <Image src="/illustrations/card-hero.png" alt="Coaches"
                fill sizes="(max-width: 768px) 100vw, 440px"
            ...
            <div className="p-7">
              ...
              <input
                ...
                disabled={submitting}
                className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-2xl tracking-[0.5em] text-center font-bold text-brand-darker focus:outline-none focus:ring-2 focus:ring-brand-lighter disabled:opacity-60"
              />
              {error && <p className="mt-2 text-sm text-red-600">{error}</p>}
              <button
                type="submit"
                disabled={submitting}
                className="mt-5 w-full py-4 rounded-xl bg-brand hover:bg-brand-darker text-white text-sm font-black tracking-widest shadow-lg transition-colors disabled:opacity-60"
              >
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {LANGUAGES.map((l) => (
            <button
              ...
              className={'text-2xl transition-transform ' + (lang === l.code ? 'scale-125' : 'opacity-60 hover:opacity-100')}
              aria-label={l.label}
            >
              {l.flag}
            </button>
